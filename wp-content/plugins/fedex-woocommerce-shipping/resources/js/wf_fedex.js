jQuery(function($){
	...
	jQuery('#woocommerce_wf_fedex_woocommerce_shipping_usmca_cirtificate').click(function(){
		ph_fedex_load_usmca_toggler();
	});
...
function ph_fedex_load_usmca_toggler(){
	var checked	=	jQuery('#woocommerce_wf_fedex_woocommerce_shipping_usmca_cirtificate').is(":checked");
